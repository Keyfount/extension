/**
 * Ambient dot-grid background ported from the marketing site's hero.
 *
 * A fixed-position canvas behind the UI, painted with a faint grid of dots
 * that fade towards the edges and brighten under the cursor. Two overlay
 * layers — a soft vignette and an SVG grain — match the site's atmosphere.
 *
 * All heavy work respects `prefers-reduced-motion` and pauses the rAF loop
