/**
 * Typed wrapper around `chrome.runtime.sendMessage` for the popup.
 *
 * Keeps the popup components free of `chrome.*` calls — easier to test in
 * isolation and to swap out the transport later if needed.
 */
