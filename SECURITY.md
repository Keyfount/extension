...
If you believe you have found a security vulnerability in ItsMyPassword, please report it **privately**.

- **Preferred:** open a [GitHub Security Advisory](https://github.com/ItsMyPassword/extension/security/advisories/new).
...
ItsMyPassword is a **deterministic** password manager. It does not store generated passwords anywhere. The security guarantees rely on:
